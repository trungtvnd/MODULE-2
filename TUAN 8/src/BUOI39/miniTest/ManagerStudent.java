...
public class ManagerStudent {
    ...
    public void createStudent(Scanner sc){
        ...
        System.out.println("Input Physical Point"); double physicalPoint = sc.nextDouble();
        System.out.println("Input Chemical Point"); double chemicalPoint = sc.nextDouble();
    ...
    public void editStudent(Scanner sc){
        ...
        for (Person stu:personHashSet) {
            if(id == stu.getId() && stu instanceof Student){
                ...
                sc.nextLine();
                System.out.println("Input age edit"); studentEdit.setAge(sc.nextInt());

                System.out.println("Input MathPoint"); studentEdit.setMathPoint(sc.nextDouble());

                System.out.println("Input PhysicalPoint"); studentEdit.setPhysicalPoint(sc.nextDouble());

                System.out.println("Input Chemical point"); studentEdit.setChemicalPoint(sc.nextDouble());
...
//
//        List.sort(Student, new Comparator<Student>() {
//            @Override
